...
The space complexity of Borůvka's algorithm is O(E + V), as we must keep a list of components that is equal to the number of vertices at the start, and a list of minimum weight connecting edges.
