...
\begin{algorithm}
    ...
    \nl \While{$|N|$ > 1}{
        ...
        \nl \For{each component $c$ in $N$}{
            ...
            \nl \For{each edge $i, j$ in $c$}{
                \nl \If{$i, j$ contains an endpoint that isn't in $c$ and $i, j$ is cheaper than $e$}{
                    \nl Set $e$ to $i, j$.
                }
            }
